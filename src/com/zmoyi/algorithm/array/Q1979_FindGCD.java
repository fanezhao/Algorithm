...
public class Q1979_FindGCD {
    ...
    public int findGCD2(int[] nums) {
        ...
        return getGreatestCommonDivisorV3(max, min);
    }
    ...
    /**
     * 辗转相除法（欧几里得算法）：两个正整数a和b（a > b），它们的最大公约数等于a除以b的余数c和b的最大公约数。
    ...
    /**
     * 更相减损术（九章算术）：两个正整数a和b（a > b），它们的最大公约数等于a减去b的余差值c和较小的b的最大公约数。
     * @param a
     * @param b
     * @return
     */
    public int getGreatestCommonDivisorV3(int a, int b) {
        int big = a > b ? a : b;
        int small = a < b ? a : b;
